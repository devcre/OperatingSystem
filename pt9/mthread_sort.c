...
int main(int argc, char **argv) 
{
	...
	// pthread_join(*first_half.t_name, (void**)&status);
	// pthread_join(*second_half.t_name, (void**)&status);
  ...
  /* 3.MERGE */
	...
	// pthread_join(tid[0], NULL); // wrong
	/* TODO: waits for the second thread 	*/
	// pthread_join(tid[1], NULL); // wrong
	/* TODO: waits for the third thread 	*/
	pthread_join(tid[2], NULL);
	// pthread_join(*merge_range.t_name, (void**)&status);
